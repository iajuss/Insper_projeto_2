...
def test_atualiza_funcao(client):
    ...
    resposta_criacao = client.post("/imoveis", json=imovel_original)
...
def test_buscar_imoveis_por_tipo_informa_links(client):
    resposta = client.get("/imoveis/tipo/Apartamento")
    dados = resposta.get_json()
...
def test_buscar_imoveis_por_tipo_informa_como_criar_imovel(client):
    resposta = client.get("/imoveis/tipo/Apartamento")
    dados = resposta.get_json()
